...
const updateAccountDetails =asyncHandler(async (req,res)=>{
    ...
    return res
    .status(200)
    .json(new ApiResponse (200 , user , "Acount details updated succesfully"))
})
...
const updateUserAvatar = asyncHandler(async(req,res)=>{
    ...
    .status(200)
    .json(
        new ApiResponse(200,user,"Avatar image upated successfully")
    )
})
...
const getChannerlUserProfile=asyncHandler(async(req,res)=>{
    ...
    .status(200)
    .json(
        new ApiResponse(200,channel[0],"User channel feched successfullt")
    )
})
